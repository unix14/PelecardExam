...
/// This is the composable that is going to draw the analog clock
/// Source code: https://github.com/alexruskovski/compose-analog-clock
/// I've scraped this code from the source above, in order to save time and not to write it from scratch
